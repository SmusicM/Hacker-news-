...
class StoryList {
  ...
  async removeStory(user,storyId){
    ...
    //might redo this like await axios.delete(url,{}) and with try and catch
    try{
    await axios({
      //url: url,
    ...
    //console.log(storyId);
     ...
     console.error("cant delete story",error);
  }
  }
    ...
    const url = `${BASE_URL}/users/${this.username}/favorites/${story.storyId}`;
     try{
      await axios({
        ...
        method :method,
        data: {token: token},
        //data: {token}, //might be this
      });
     }catch(error){
       console.error("something went wrong in addOrRemoveFav",error.message);
     }
  }
